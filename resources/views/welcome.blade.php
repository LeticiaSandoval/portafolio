...
<html lang="en-US">
    ...
    <body>
                    ...
                    <li>
                        <div class="image-caption">
                            <div class="inner">
                                ...
                                <a class="btn btn-primary white nofill scrollTo" href="#services"><i class="fa fa-play"></i> High Quality Services</a>
                            </div>
                        </div>
        ...
        <section id="about">
            <div class="container">
                ...
                <div class="me-picture text-center">
                    <div class="item">
                        <img class="img-responsive" src="assets/images/preview/content/people/2.jpg" width="200" height="200" alt="" />
                    </div><hr />
                </div>
                    ...
                    <div class="row">
                        ...
                        <ul class="sort-destination isotope" data-sort-id="isotope-list">
                            ...
                            <li class="isotope-item col-sm-6 col-md-4 image"><!-- item -->
                                <a class="popup-image" href="assets/images/preview/slider/1.jpg">
                                    <img src="assets/images/preview/content/portfolio/p1.jpg" class="img-responsive" alt="img" />
                                    <div class="caption">
                            ...
                            <li class="isotope-item col-sm-6 col-md-4 video"><!-- item -->
                                <a class="popup-video" href="https://player.vimeo.com/video/337806774">
                                    <img src="assets/images/preview/content/portfolio/p2.jpg" class="img-responsive" alt="img" />
                                    <div class="caption">
                                        <i class="rounded fa fa-film"></i>
                                        <h3>EL LUGAR M&Aacute;S CERCA DE DIOS</h3>
                                        <p>Vimeo Video</p>
                                    </div>
                                </a>
                            </li>
                            ...
                            <li class="isotope-item col-sm-6 col-md-4 video"><!-- item -->
                                <a class="popup-video" href="http://vimeo.com/23630702">
                                    <img src="assets/images/preview/content/portfolio/p3.jpg" class="img-responsive" alt="img" />
                                    <div class="caption">
                                        <i class="rounded fa fa-film"></i>
                                        <h3>PROJECT TITLE</h3>
                                        <p>Vimeo Video</p>
            ...
            <div class="container">
                ...
                <article>
                    <p class="text-center big-paragraph">
                        Drop me a line or just say <strong><em>Hello!</em></strong>
        ...
        <!-- QUOTE -->
        <section class="cover" style="background-image:url('assets/images/preview/slider/road.jpg')">
            <span class="overlay"></span>
